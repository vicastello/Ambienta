...
echo "4. Adicione CADA uma dessas variáveis:"
echo ""
...
echo ""
echo "   KEY: TINY_ACCESS_TOKEN"
echo "   VALUE: (copie do seu .env.local ou da integração Tiny)"
echo ""
echo "   KEY: TINY_CLIENT_ID"
echo "   VALUE: tiny-api-96c52ae7713211e99e3d9fd50ee4385d928437a7-1763324548"
echo ""
echo "   KEY: TINY_CLIENT_SECRET"
echo "   VALUE: vTDeowXckMitwa9brXA2w8CX64m9Axdh"
echo ""
