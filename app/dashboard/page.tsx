                                ...
                                {pedido.primeiraImagem ? (
                                  <>
                                    ...
                                    {(pedido.itensQuantidade ?? 0) > 1 && (
                                      <span className="absolute top-0 right-0 translate-x-1/2 -translate-y-1/2 bg-white text-[var(--accent)] border border-[var(--accent)] rounded-full px-1.5 py-0.5 text-[10px] font-bold" style={{zIndex:50}}>
                                        +{(pedido.itensQuantidade ?? 0) - 1}
                                      </span>
                                    )}
                                  </>
