...
export function StickyTotalsBar({
    ...
    return (
        <div className="fixed bottom-8 left-0 right-0 z-[100] px-4 pointer-events-none flex justify-center animate-slide-in-bottom">
            <div className="inline-flex pointer-events-auto items-center gap-6 px-6 py-4 rounded-2xl bg-slate-900/60 dark:bg-slate-900/60 backdrop-blur-2xl border border-white/10 shadow-2xl">
                {/* Métricas */}
                <div className="flex items-center gap-6">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div className="flex flex-col">
                            ...
                            <AnimatedCounter value={selectedCount} className="text-lg font-bold text-white" />
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div className="flex flex-col">
                            ...
                            <AnimatedCounter value={totalQuantidade} className="text-lg font-bold text-white" />
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div className="flex flex-col">
                            ...
                            <AnimatedCurrency value={totalValor} className="text-lg font-bold text-white" />
                        </div>
                    </div>
                </div>
