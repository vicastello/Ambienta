...
export function AppDatePicker({
    ...
    return (
        <div className="relative h-full flex items-center justify-end" ref={containerRef}>
            <button
                type="button"
                onClick={() => setIsOpen(!isOpen)}
                className="h-full w-9 flex items-center justify-center rounded-r-lg text-[var(--color-neutral-500)] hover:text-[var(--color-primary)] hover:bg-[var(--color-neutral-100)] dark:hover:bg-[var(--color-neutral-800)] transition-colors"
