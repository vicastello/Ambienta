              ...
              {derivados.map((p, idx) => (
                <tr key={p.id_produto_tiny} className="align-top">
                  <td className="px-4 py-3">
                    <span className="inline-flex items-center justify-center w-8 h-8 rounded-full border border-white/60 dark:border-white/15 bg-white/80 dark:bg-white/10 text-[#009DA8] text-xs font-extrabold">
                      {idx + 1}
                    </span>
                  </td>
                  <td className="px-4 py-3">
