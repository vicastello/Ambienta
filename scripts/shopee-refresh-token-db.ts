...
// Load .env.vercel para Supabase, então .env.local para sobrescrever com credenciais Shopee corretas
...
if (fs.existsSync(envLocalPath)) {
    ...
    for (const k in envConfig) process.env[k] = envConfig[k]; // override
}
